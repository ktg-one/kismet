 ...
 * Cards scrub with scroll via ScrollReveal and lift with a gold glow on hover.
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {cards.map((c, i) => (
            <ScrollReveal
              key={i}
              className={`${
                c.size === "lg" ? "md:col-span-2" : "md:col-span-1"
              }`}
            >
              <article
                className={`glass-card p-8 md:p-10 flex flex-col justify-end min-h-[360px] md:min-h-[400px] relative overflow-hidden group h-full transition-all duration-300 hover:-translate-y-2.5 hover:shadow-[0_30px_80px_-28px_rgba(212,175,55,0.38)] ${
          ...
          <ScrollReveal className="md:col-span-3">
            <article className="glass-card p-8 md:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-10 group transition-all duration-300 hover:-translate-y-1.5">
