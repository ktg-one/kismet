        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 relative">
          ...
          {steps.map((step, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`bg-[#17202b] border border-[#43474e]/30 rounded-lg p-8 md:p-10 flex flex-col md:flex-row gap-6 md:gap-8 items-start group hover:bg-[#212b36] transition-colors duration-500 relative overflow-hidden ${
